...
import { Folders, LayoutDashboard, Users2, Settings, Columns3, BarChart3 } from "lucide-react";

export function Sidebar({ role }: { role: Role }) {
  const pathname = usePathname();
  const links = [
    { href: "/dashboard", label: "My projects", icon: LayoutDashboard, show: true, exact: true },
